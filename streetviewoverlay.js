...
{
    // Trafalgar Square
    this.slat = 24.124356;///////////////////////////24.124253, 120.675150
    this.slng = 120.675139;///////////////////////////, 120.675016
    this.zoom = 16;

    this.lat = 24.12368;///////////圖片位置
    this.lng = 120.67497;////////////////

    this.image = "campu2.jpg";

    this.pt = new google.maps.LatLng(this.lat, this.lng);
    this.streetPt = new google.maps.LatLng(this.slat, this.slng);

    // initial POV
    this.sheading = 198.073;//////////////////////////仰俯角
    this.spitch = 5.972;/////////////////仰俯角
    this.szoom = 1;
